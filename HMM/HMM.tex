...
\begin{align}
    \begin{aligned}
        ...
        &= \frac{1}{p(\bm{z}_n)}\sum_{\bm{z}_{1:n-1}} p(\bm{z}_1) \prod_{k=2}^n p(\bm{z}_k|\bm{z}_{k-1}) \prod_{k=1}^n p(\bm{x}_k|\bm{z}_k) \\
    \end{aligned}
    \label{}
\end{align}
と変形する事が出来る。正しここで
...
\begin{align}
    \begin{aligned}
        ...
        & \quad = \left\{\frac{1}{p(\bm{z}_n)}\sum_{\bm{z}_{1:n-1}} p(\bm{z}_1) \prod_{k=2}^n p(\bm{z}_k|\bm{z}_{k-1}) \prod_{k=1}^n p(\bm{x}_k|\bm{z}_k)\right\}\left\{ \sum_{\bm{z}_{n+1},\cdots,\bm{z}_N} \prod_{k=n+1}^N p(\bm{z}_k|\bm{z}_{k-1}) \prod_{k=n+1}^N p(\bm{x}_k|\bm{z}_k)\right\} \\
